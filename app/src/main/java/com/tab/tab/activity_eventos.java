    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boton_eventos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(activity_eventos.this, activity_eventos.class);
        ...
        boton_perfil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(activity_eventos.this, activity_perfil.class);
                startActivity(intent);
                finish();
            }
        });

        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.eventos), (v, insets) -> {
